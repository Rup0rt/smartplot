...
with PdfPages(outputfile) as pdf:
  ...
  firstPage.text(0.05, 0.80, "Source file: " + source, transform=firstPage.transFigure, size=24)
  ...
  if event:
    firstPage.text(0.05, 0.60, "Configured event on date: " + event, transform=firstPage.transFigure, size=24)
  pdf.savefig()
  plt.close()
